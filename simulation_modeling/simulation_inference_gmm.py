...
class SimulationInference_gmm(object):
    def __init__(self, configs):
        ...
        self.history_length, self.pred_length, self.m_tokens, self.n_gaussian, self.sample_times = configs["history_length"], configs["pred_length"], configs["m_tokens"], configs["n_gaussian"], configs["sample_times"]
