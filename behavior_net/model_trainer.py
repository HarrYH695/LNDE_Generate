...
class Trainer(object):
    ...
    def __init__(self, configs, dataloaders):
        ...
        self.regression_loss_func_pos = UncertaintyRegressionLoss(choice='mse')
    ...
    def _collect_epoch_states(self):
        ...
        #     print(f"val_epoch_std_x:{self.val_epoch_std_x}, val_epoch_std_y:{self.val_epoch_std_y}, train_epoch_corr:{self.val_epoch_corr}")
    ...
    def _compute_acc(self):
        ...
        # G_pred_std0 = torch.sqrt(self.G_pred_std[0]) * mask_pos
