...
parser.add_argument('--save-result-path', type=str, default=r'/nfs/turbo/coe-mcity/hanhy/LNDE_Training_Res/results_gmn_new4/training/behavior_net',
...
# python run_training_gmn.py --config ./configs/rounD_behavior_net_training.yml --experiment-name rounD_nG3_NllAndL1_test